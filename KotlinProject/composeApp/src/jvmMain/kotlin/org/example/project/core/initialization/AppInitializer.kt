...
object AppInitializer {
    ...
    suspend fun initialize(onProgress: (String, Float) -> Unit = { _, _ -> }): Result<Unit> =
    ...
    private suspend fun setupAIBackend(onProgress: (String, Float) -> Unit): Boolean {
        return try {
            ...
            var backendSetupSuccess =
                BackendManager.setupBackendEnvironment { step, progress ->
