...
class DeepSeekWordValidationService {
        ...
        runCatching {
            ...
            if (response.status.value in 200..299) {
                ...
                WordDefinition(
                    word = returnedWord,
                    definition =
                        jsonResponse["definition"]?.jsonPrimitive?.content
    ...
    private fun parseTextResponse(
        ...
        // Extract example
        val exampleMatch =
            Regex("\"example\"\\s*:\\s*\"([^\"]+)\"", RegexOption.IGNORE_CASE)
