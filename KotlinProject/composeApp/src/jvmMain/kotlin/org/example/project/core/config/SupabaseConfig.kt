...
object SupabaseConfig {
    ...
    private fun findEnvFile(): File? {
            ...
            if (codeSource != null) {
                ...
                if (executableDir.name == "bin") {
                    executableDir.parentFile?.let { appDir ->
                        ...
                        println(debugMsg3)
                        try { logFile.appendText("$debugMsg3\n") } catch (e: Exception) {}
                        ...
                        appDir.parentFile?.let { installRoot ->
                            ...
                            println(debugMsg4)
                            try { logFile.appendText("$debugMsg4\n") } catch (e: Exception) {}
        ...
        println(debugMsg5)
        try { logFile.appendText("$debugMsg5\n") } catch (e: Exception) {}
        ...
        possibleLocations.forEach { location ->
            ...
            println(statusMsg)
            try { logFile.appendText("$statusMsg\n") } catch (e: Exception) {}
        }
        ...
        if (found != null) {
            ...
            println(successMsg)
            try { logFile.appendText("$successMsg\n") } catch (e: Exception) {}
        } else {
            val errorMsg = "Debug: No .env file found in any checked location!"
            println(errorMsg)
            try { logFile.appendText("$errorMsg\n") } catch (e: Exception) {}
        }
