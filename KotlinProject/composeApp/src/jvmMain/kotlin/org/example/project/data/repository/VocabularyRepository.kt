...
interface VocabularyRepository {
    ...
    suspend fun addWordToUserVocabulary(
        userId: String,
        wordId: String,
    ): Result<UserVocabularyWord>

    suspend fun updateUserWordStatus(
        userId: String,
        wordId: String,
    ...
    suspend fun getUserWordsByStatus(
        userId: String,
        status: VocabularyStatus,
    ): Result<List<UserVocabularyWord>>

    suspend fun removeWordFromUserVocabulary(
        userId: String,
        wordId: String,
    ): Result<Unit>
