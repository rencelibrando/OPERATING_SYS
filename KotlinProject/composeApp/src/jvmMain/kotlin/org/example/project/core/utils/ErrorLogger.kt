...
object ErrorLogger {
     ...
     */
    fun logException(fileName: String, exception: Throwable, additionalContext: String? = null) {
        val baseMessage = exception.message ?: "Unknown error"
        val sanitizedMessage = sanitizeMessage(baseMessage)
        
        val fullMessage = if (additionalContext != null) {
     ...
     */
    fun logWarning(fileName: String, message: String) {
        val sanitizedMessage = sanitizeMessage(message)
     ...
     */
    fun logInfo(fileName: String, message: String) {
        val sanitizedMessage = sanitizeMessage(message)
     ...
     */
    fun logDebug(fileName: String, message: String) {
 ...
 */
fun String.logException(exception: Throwable, context: String? = null) {
